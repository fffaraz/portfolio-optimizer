...
{
    std::cerr << "Portfolio::Portfolio [csvPath] " << csvPath << std::endl;
...
{
    std::cout << "Portfolio::saveCsv [csvPath] " << csvPath << std::endl;
...
{
    std::cout << "Portfolio::saveSymbols [filePath] " << filePath << std::endl;
